...
This analysis is based on interactive dashboards developed in Power BI using simulated data inspired by a large-scale food delivery platform. The visualizations consolidate operational, financial, and customer experience indicators, providing an integrated view of sales performance, consumer behavior, geographic distribution, and service quality.
...
In summary, the data highlight an economically scalable and financially solid model, albeit with clear strategic challenges related to service quality, experience standardization, and the maximization of customer lifetime value—critical aspects for sustaining long-term growth and profitability.

## 4. Conclusions and Recommendations

The integrated analysis of economic, financial, and operational indicators demonstrates that the delivery business model exhibits high scalability, broad territorial coverage, and consistent financial performance, supported by a substantial volume of orders, a stable average ticket value, and recurring consumption. However, despite this quantitative robustness, the data reveal relevant qualitative weaknesses, particularly regarding customer experience and the standardization of services provided by partner establishments. The average level of customer satisfaction, combined with the high proportion of negative reviews, constitutes a strategic risk to customer loyalty and the long-term sustainability of growth.

In this context, the following recommendations are proposed:

 - Strengthening governance mechanisms and partner quality control through more rigorous criteria for remaining on the platform;
 - Implementing training programs and incentive schemes linked to performance in customer ratings and repeat purchase behavior;
 - Adopting commercial strategies aimed at increasing customer lifetime value, such as loyalty programs, personalized offers, bundles, and campaigns targeted at age segments with higher participation and purchasing power.

Additionally, the regional concentration of operations indicates the need for differentiated strategies by state, leveraging mature markets with a focus on efficiency and quality, while simultaneously promoting controlled expansion in regions with lower operational density but high growth potential. Finally, the continuous use of Business Intelligence is recommended as a central decision-support tool, enabling real-time monitoring, early identification of operational deviations, and strategic alignment between growth, profitability, and customer satisfaction.
