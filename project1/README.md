# Forecasting Coffee Export Values Using Artificial Intelligence
...
## Source Code
- All scripts and notebooks are available in the [code folder](https://github.com/Benfluc/Projects/project1/code)  
